...
public class CompanyController {
    ...
    public ModelAndView Company(Company company) {
    ...
    //    注册公司
    @RequestMapping(value = "/stepForm")
    public ModelAndView CompleteCom123(Company company, HttpSession session) {
        String email = (String) session.getAttribute("email");
        company.setEmail(email);
        System.out.println(company);
        companyService.CompleteCom(company);
