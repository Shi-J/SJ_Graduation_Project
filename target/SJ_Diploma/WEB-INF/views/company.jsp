        ...
        <div class="content_mid">
        	<dl class="c_section c_section_mid">
                ...
                <dd>
	                ...
	                <form id="stepForm" action="stepForm" method="post">
	                    ...
	                    <h3>所在城市</h3>
	                    <input type="text" placeholder="请输入工作城市 比如：长沙" name="city" id="city">

	                    <h3>行业领域</h3>
	                    <div>
		                    <input type="hidden" value="" name="select_industry_hidden" id="select_industry_hidden">
		                    <input type="text" placeholder="请选择行业领域" name="select_industry_hidden" id="select_industry" class="select">
<%--							<select name="select_industry">--%>
...
<%--							</select>--%>
	                    ...
	                    <div>
		                    ...
		                    <input type="text" placeholder="请选择公司规模" name="select_scale_hidden" id="select_scale" class="select">
